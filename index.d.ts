...
export declare function tryValidate<T>(value: unknown, validator: Validator<T>): value is T;
export declare function parseJSON<T>(json: string, validator: Validator<T>, expression?: string): T;
export declare function tryParseJSON<T>(json: string, validator: Validator<T>): T | undefined;
